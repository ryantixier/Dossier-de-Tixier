...
import workoutWizard from "../assets/images/lilguy_with_eyes_workout_wizard_on_trans.png";
...
export default function Section() {
  ...
  return (
    <>
      <img src={workoutWizard} alt="Workout Wizard" />
          ...
          <Collapse in={expanded} timeout="auto" unmountOnExit>
            <CardContent>
              <Typography paragraph>
                ...
                compainion; design and track workouts according to your needs
                and goals!
              </Typography>
              <Typography paragraph>
